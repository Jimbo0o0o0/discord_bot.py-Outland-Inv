...
class General(commands.Cog, name="general"):
    ...
    @commands.hybrid_command(name="server",description="Get the invite link of the discord server of the bot for some support.",)
    async def server(self, context: Context) -> None:
        ...
        """
        embed = discord.Embed(
            description=f"Join the support server for the bot by going on github.",
            color=0xD75BF4,
        )
        try:
            await context.author.send(embed=embed)
